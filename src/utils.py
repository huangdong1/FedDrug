...
class TestbedDataset(InMemoryDataset):
    def __init__(self, root='data', dataset='davis', path='data/processed/',
        ...
        if os.path.isfile(path):
            print('Pre-processed data found: {}, loading ...'.format(path))
...
class GNNDataset(InMemoryDataset):
    ...
    def __init__(self, root, path, train=True, transform=None, pre_transform=None, pre_filter=None):
